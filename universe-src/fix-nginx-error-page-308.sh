#!/bin/bash
# ИСПРАВЛЕНИЕ: Использование error_page для перехвата редиректов 308

echo "=========================================="
echo "ИСПРАВЛЕНИЕ CORS 308: ERROR_PAGE ДЛЯ ПЕРЕХВАТА"
echo "=========================================="
echo ""
...
server {
    ...
    # КРИТИЧНО: Обработка OPTIONS для /api/datalab/auth/register
    # Используем точное совпадение и обрабатываем OPTIONS ДО proxy_pass
