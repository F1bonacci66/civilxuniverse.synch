...
export default function ModelPivotPage({
  params,
}: {
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-[rgba(0,0,0,0.6)] backdrop-blur-[10px] rounded-lg p-6 border border-[rgba(255,255,255,0.1)]">
          <h2 className="text-2xl font-bold text-white mb-4">Сводный расчет</h2>
          <p className="text-[#999]">
            Здесь будет отображаться сводный расчет. Реализация будет добавлена позже.
          </p>
        </div>
      </div>
    </div>
