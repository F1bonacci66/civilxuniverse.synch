#!/bin/bash
echo "=========================================="
echo "РАБОЧЕЕ ИСПРАВЛЕНИЕ NGINX ДЛЯ /signup/"
echo "=========================================="
echo ""
...
server {
    ...
    # Используем proxy_pass с явным указанием пути
    location = /api/datalab/auth/signup/ {
        ...
        # Проксируем с явным указанием пути
        proxy_pass http://127.0.0.1:8000/api/datalab/auth/signup/;
