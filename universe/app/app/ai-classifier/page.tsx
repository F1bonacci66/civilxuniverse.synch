...
import { Folder, Plus, Loader2, Brain } from 'lucide-react'
import { useRouter } from 'next/navigation'
import { getProjects, type Project } from '@/lib/api/projects'
import { SVORUpload } from '@/components/ai-classifier/SVORUpload'
    ...
    <div className="p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-4xl font-bold text-gradient mb-2">СВОР Классификатор</h1>
            <p className="text-[#ccc] text-lg">Автоматическая классификация элементов по СВОР</p>
            <p className="text-[#999] text-sm mt-2">
              Автоклассификация. Требует подтверждения пользователя.
            </p>
          </div>
        </div>

        {/* Карточка загрузки СВОР - показывается всегда */}
        <div className="mb-8">
          <Card className="bg-[rgba(0,0,0,0.3)] border-[rgba(255,255,255,0.1)]">
            <CardHeader>
              <CardTitle className="text-xl text-white">Управление позициями СВОР</CardTitle>
              <CardDescription>
                Загрузите CSV файл с позициями СВОР для классификации элементов
              </CardDescription>
            </CardHeader>
            <CardContent>
              <SVORUpload />
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-[#999] mb-6">Создайте проект в DataLab, чтобы начать классификацию</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              return (
                <Card
                  ...
                  onClick={() => router.push(`/app/ai-classifier/project/${projectRouteId}`)}
                >
                  <CardHeader>
